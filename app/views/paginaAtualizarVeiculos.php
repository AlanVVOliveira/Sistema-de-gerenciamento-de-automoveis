...
<body>
    ...
    <div class="container-fluid">
        ...
        <h2 id="titulo">Editar Veículo</h2>
        <form id="formulario">

            <div class="form-group">
                    <label for="id_veiculo">ID:</label>
                    <input type="number" step=".01" class="form-control" id="id_veiculo" name="id_veiculo"  
                    placeholder="Digite o ID do veículo" required>
            </div>
            ...
            <div class="form-group">
                    ...
                    placeholder="Digite nome do fabricante">
            </div>
            ...
            <div class="form-group">
                    ...
                    placeholder="Digite modelo do veiculo">
            </div>
            ...
            <div class="form-group">
                    <label for="combustivel_veiculo">Combustível:</label>
                    <input type="text" data-toggle="popover" title="Escolha alguma dessas opções: gasolina / alcool 
                    / diesel / flex / eletrico / hibrido" step=".01" class="form-control" id="combustivel_veiculo" 
                    name="combustivel_veiculo" placeholder="Digite o combustível">
            </div>
            ...
            <div class="form-group">
                    ...
                    <input type="text" data-toggle="popover" title="Permite o formato antigo e atual. Não permite o - " 
                    step=".01" class="form-control" id="placa_veiculo" name="placa_veiculo" placeholder="Digite a placa">
            </div>
...
<script src="../views/js/scriptAtualizarVeiculo.js"></script>
